...
use methods::POSEIDON_NATIVE_RISC_ZERO_METHODS_GUEST_ELF;
...
fn main() {
    ...
    let prove_info = prover.prove_with_opts(env, POSEIDON_NATIVE_RISC_ZERO_METHODS_GUEST_ELF, &ProverOpts::groth16()).unwrap();
