...
use methods::NTH_PRIME_WASM_RISC_ZERO_METHODS_GUEST_ELF;
...
fn main() {
    ...
    let prove_info = prover.prove_with_opts(env, NTH_PRIME_WASM_RISC_ZERO_METHODS_GUEST_ELF, &ProverOpts::groth16()).unwrap();
